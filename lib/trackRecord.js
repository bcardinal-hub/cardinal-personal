...
// Returns the captured price (or null) so the caller can reflect it in the
// same response it's about to send back, instead of the client seeing a
// stale null until the next page load.
