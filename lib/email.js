...
// "from" yet. Swap to a verified cardinal-personal.com address once one
// exists; deliverability on a real domain is meaningfully better.
const FROM = "Cardinal Personal <onboarding@resend.dev>";
...
export async function sendPasswordResetEmail(toEmail, resetUrl) {
  ...
  const response = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      from: FROM,
      to: [toEmail],
      subject: "Reset your Cardinal Personal password",
      text: `Someone (hopefully you) requested a password reset for your Cardinal Personal account.\n\nReset your password: ${resetUrl}\n\nThis link expires in 1 hour. If you didn't request this, you can safely ignore this email — your password hasn't been changed.`,
      html: `<p>Someone (hopefully you) requested a password reset for your Cardinal Personal account.</p><p><a href="${resetUrl}">Reset your password</a></p><p>This link expires in 1 hour. If you didn't request this, you can safely ignore this email — your password hasn't been changed.</p>`,
    }),
  });
  if (!response.ok) {
