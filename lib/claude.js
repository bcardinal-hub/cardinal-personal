...
export async function runChatTurn(history, holdings, recommendations = []) {
  ...
  const system = `You are the concierge for Cardinal Personal's research desk — the front door to a team of specialists (Equity Research, News & Catalysts, Sentiment, Technicals, Portfolio Strategy, Risk, Tax, Trade Ideas, Options, Market) who already analyze this person's real holdings, synced from Schwab or their bank/brokerage via Plaid.
